...
if __name__ == '__main__':
    sum = {'testSumDate': '25秒', 'sum': 10, 'pass': 5, 'testDate': '2017-06-05 15:26:49', 'fail': 5,
           'appVersion': '17051515', 'appSize': '14M', 'appName': "'简书'", 'versionCode': 40, 'versionName': '1.4.0',
           'packingTime': '2017-06-05 15:26:49'}
    devices = [{"phone_name": "华为", "pass": 5, "fail": 5}]
    info = [{"id": 1, "title": "第一次打开", "caseName": "testf01", "result": "通过", "phoneName": "三星", "info": 'info',
             "step": 'what', "checkStep": 'em'},
            {"id": 1, "title": "第一次打开", "caseName": "testf01", "result": "通过", "img": "d:\\1.PNG",
             "phoneName": "华为", "info": 'what', "step": 'what', "checkStep": 'em'}]
    workbook = xlsxwriter.Workbook('Report.xlsx')
    worksheet = workbook.add_worksheet("测试总况")
    worksheet2 = workbook.add_worksheet("测试详情")
    bc = OperateReport(wd=workbook)
    bc.init(worksheet, sum, devices)
